...
class GameMode(Mode):
    ...
    def appStarted(mode):
        ...
        #mode.playerImage1 = mode.loadImage('hawkeye.jpg')
...
class CustomizeMode(Mode):
    ...
    def redrawAll(mode, canvas):
        ...
        canvas.create_text(mode.width*(1/4), mode.height/2 + 130, text = "Q for Yondu", font = "Guardians 9 bold", fill = "Green")
        canvas.create_image(mode.width*(2/4), mode.height/2, image=ImageTk.PhotoImage(mode.hawkeye))
        canvas.create_text(mode.width*(2/4), mode.height/2 + 130, text = "W for Hawkeye", font = "Guardians 9 bold", fill = "Green")
        canvas.create_image(mode.width*(3/4), mode.height/2, image=ImageTk.PhotoImage(mode.greenArrow))
        canvas.create_text(mode.width*(3/4), mode.height/2 + 130, text = "E for Green Arrow", font = "Guardians 9 bold", fill = "Green")
